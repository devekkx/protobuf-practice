...
const file_main_proto_rawDesc = "" +
	...
	"\rHelloResponse\x12!\n" +
	"\fconf_message\x18\x01 \x01(\tR\vconfMessage2m\n" +
	"\fHelloService\x123\n" +
...
var file_main_proto_depIdxs = []int32{
	...
	2, // 1: main.HelloService.GetUserOrder:input_type -> user.User
	1, // 2: main.HelloService.SayHello:output_type -> main.HelloResponse
	3, // 3: main.HelloService.GetUserOrder:output_type -> order.Order
